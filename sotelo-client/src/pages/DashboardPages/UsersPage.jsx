...
const UsersPage = () => {
  ...
  const validate = () => {
    ...
    // Enhancement 3: Strict Validations
  ...
  // Filter Logic Implementation (Enhancement 2)
    ...
    <Box sx={{ width: '100%', minWidth: 0 }}>
      ...
      >
        ...
        <Button
          variant="contained"
          onClick={() => openModal()}
          sx={{ width: { xs: '100%', sm: 'auto' }, backgroundColor: '#aa3bff', '&:hover': { backgroundColor: '#8a2be2' } }}
        >
          Add Artist
        </Button>
      </Box>

      {/* Enhancement 2: Search and Filter Bar */}
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <DialogContent dividers sx={{ px: { xs: 2, sm: 3 } }}>
            <Stack spacing={2} sx={{ pt: 1 }}>
              ...
              {/* FIXED: Using slotProps for the latest MUI version to display the Eye Icon correctly */}
              <TextField
              ...
              <FormControlLabel
                ...
                label={form.isActive ? 'Artist status: Active' : 'Artist status: Inactive'}
              />
            </Stack>
          </DialogContent>
