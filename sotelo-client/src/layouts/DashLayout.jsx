...
export default function DashLayout() {
  ...
  const navItems = [
    ...
    { label: 'Articles', to: '/dashboard/articles', icon: <OpenInNewIcon /> },
  ];

  // Enhancement 1: Hide Users page if role is 'editor'
  if (role !== 'editor') {
    navItems.splice(2, 0, { label: 'Users', to: '/dashboard/users', icon: <PeopleIcon /> });
  }
